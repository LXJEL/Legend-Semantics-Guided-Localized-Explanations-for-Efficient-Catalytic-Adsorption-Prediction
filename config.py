...
class Config(object):
    def __init__(self, args):
        ...
        # Use CatBERTa-style learning-rate scaling for attention and new-layer heads when requested.
        ...
        # Lower default sigma makes the distance bias sharper.
        self.geom_distance_sigma = 3.0
        self.geom_distance_flat = 5.0
        # Mean distance aggregation is the default reduction.
        ...
        # Data paths.
        # Root dir can be overridden by --dataset_root; otherwise use the default path.
        self.dataset_root = getattr(
            args, "dataset_root",
            "./external/oc20data_proc"
        )
        # Dataset split files can be overridden from the CLI.
        ...
        # EquiformerV2 default hyperparameters.
        ...
        # Preserve backward compatibility for external code that expects config.dataset.
        self.dataset = self.dataset_root
        # Logging and checkpoints.
        self.checkpoint = args.checkpoint
        self.log_dir = args.log_dir
        # The _pa suffix denotes per-atom metrics.
        self.log_save_name = getattr(args, "log_save_name", "oc20_catgt.json")
        # Enable geometry-importance logging.
